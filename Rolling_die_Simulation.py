...
#===================================Simulation page========================================
    ...
    def simulate_page(self):
        ...
        answer_entry = Entry(simulate_window,textvariable = answer_entry,width = 2,fg = "black",bg = "white",
                                   font=('Helvetica', '25'))#Entrybox for taking input
    ...
    #==========================Function for rolling a die=====================================
        def roll_die():#function for rolling a die
            ...
            try:
                ...
                try:
                    for i in range(1,int(no_of_dice)+1):
    ...
    def landing_page(self):
        ...
        start_button = Button(self.win,text = start,fg = "white",cursor = 'hand2',bg = "black",font=('Helvetica', '30'),command  = lambda:self.simulate_page())
